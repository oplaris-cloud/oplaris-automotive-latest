...
export const RegPlateInput = forwardRef<HTMLInputElement, RegPlateInputProps>(
  function RegPlateInput({ variant = "front", className, ...props }, ref) {
    ...
    return (
      ...
      >
        {/* Blue side strip */}
        <div className="flex w-10 flex-shrink-0 flex-col items-center justify-center bg-[#003da5] py-1.5">
          <svg
            viewBox="0 0 24 24"
            className="h-4 w-4"
            fill="none"
          ...
          <span className="mt-0.5 text-[9px] font-bold leading-none text-white">
            UK
          </span>
        </div>
        {/* Plate input */}
        <input
          ...
          {...props}
          className={cn(
            "flex-1 border-none px-3 py-2.5 text-center font-mono text-2xl font-black uppercase tracking-[0.15em] outline-none placeholder:text-gray-400 placeholder:font-normal placeholder:text-base placeholder:tracking-normal",
