...
|---|---|---|---|---|
| T0 | Build & static analysis | DONE | 1 blocker / 0 major (fixed) | Pre-deploy |
| T1 | Unit tests | DONE | 0 blocker / 1 major (fixed) | Pre-deploy |
| T2 | RLS & database integrity | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 0 major | Pre-deploy |
| T3 | Auth & role enforcement | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 1 major (logged) | Pre-deploy |
| T4 | Core workflow: job lifecycle | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 0 major | Pre-deploy |
| T5 | Core workflow: customer approval SMS | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 1 major (fixed) | Pre-deploy |
| T6 | Core workflow: customer status page | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 1 major (fixed) + 1 minor logged | Pre-deploy |
| T7 | Core workflow: tablet kiosk | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 1 major (fixed) + 2 minors logged | Pre-deploy |
| T8 | Parts, uploads, PDF | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 0 major | Pre-deploy |
| T9 | M2 features: warranty, stock, DVSA, reports, GDPR | STATIC-PASS (dynamic SKIPPED) | 0 blocker / 3 major (fixed) | Pre-deploy |
| T10 | Security hardening | STATIC-PASS (gitleaks SKIPPED) | 0 blocker / 0 major | Pre-deploy |
| T11 | Cross-browser & mobile | SKIPPED | — | Pre-deploy |
| T12 | E2E Playwright (automated) | DONE | 0 blocker / 0 major | Pre-deploy |
